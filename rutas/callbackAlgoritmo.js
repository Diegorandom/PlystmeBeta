...
/*Headers necesarios para comunicacion con API de Spotify*/
  ...
  if(objetosGlobales[positionRefresh] == undefined ||objetosGlobales[positionRefresh].refresh_token == null){
  ...
  }else if(objetosGlobales[positionRefresh].refresh_token != null){
