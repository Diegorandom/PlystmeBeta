...
if(error == true){
    ...
    .then(function(response){
        response.records.forEach(function(record){
            totalUsers = record._fields[[0]].low; 
        });
